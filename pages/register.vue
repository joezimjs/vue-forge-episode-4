				...
				<div class="card-body">
					...
					<form @submit.prevent="signUp">
						<label class="block mb-5">
							...
							<input class="w-full input" type="email" v-model="form.email" data-test-id="email" />
						</label>

						<label class="block mb-5">
							<div>Password</div>
							<input class="w-full input" type="password" v-model="form.password" data-test-id="password" />
						</label>

						<label class="block mb-5">
							<div>Confirm Password</div>
							<input class="w-full input" type="password" v-model="form.confirmPassword" data-test-id="confirm-password" />
						</label>
